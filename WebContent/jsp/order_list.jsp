					...
					<c:forEach items="${page.list }" var="o">
						<tbody>
							<tr class="success">
								...
								<c:if test="${o.state==1}">	
									<a href="${pageContext.request.contextPath}/"> 待付款</a>
								</c:if>
								
								<c:if test="${o.state==2}">待发货</c:if>
								
								<c:if test="${o.state==3}">
									<a href="${pageContext.request.contextPath}/OrderServlet?method=findOrderByOid=${o.oid}"> 待签收</a>
								</c:if>
							...
							<c:forEach items="${o.list }" var="items">
								<tr class="active">
